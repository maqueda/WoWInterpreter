...
OutputDir=installer
OutputBaseFilename=WoWInterpreter-2.2.1-Setup
Compression=lzma2
...
[Files]
Source: "Documentation\WoWInterpreter-2.2.1-User-Guide-English.docx"; DestDir: "{app}\Documentation"; Flags: ignoreversion
Source: "Documentation\WoWInterpreter-2.2.1-User-Guide-Chinese-Simplified.docx"; DestDir: "{app}\Documentation"; Flags: ignoreversion
...
[Icons]
Name: "{group}\User Guide - English"; Filename: "{app}\Documentation\WoWInterpreter-2.2.1-User-Guide-English.docx"
Name: "{group}\用户指南 - 简体中文"; Filename: "{app}\Documentation\WoWInterpreter-2.2.1-User-Guide-Chinese-Simplified.docx"
