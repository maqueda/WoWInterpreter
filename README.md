...
**English â†” Simplified Chinese communication assistant for World of Warcraft Classic Era.**

[ç®€ä½“ä¸­æ–‡è¯´æ˜Ž](README_zh-CN.md) Â· [User Guide](Documentation/WoWInterpreter-2.1.5-User-Guide-English.docx) Â· [ä¸­æ–‡ç”¨æˆ·æŒ‡å—](Documentation/WoWInterpreter-2.1.5-User-Guide-Chinese-Simplified.docx)
...
- English â†’ Simplified Chinese and Simplified Chinese â†’ English.
...
If the grid appears but no translation is produced, right-click the **WI** tray icon â†’ **Open diagnostic log**. A healthy first model load should eventually show:
